...
$idp_host = env('SAML2_IDP_HOST', 'https://idp.saml.authworkshop.com');
...
return $settings = array(
    ...
    'sp' => array(
        ...
        'entityId' => env('SAML2_SP_ENTITYID','sp.saml.authworkshop.com'),
    ...
    'idp' => array(
        ...
        'entityId' => env('SAML2_IDP_ENTITYID', 'idp.saml.authworkshop.com'),
        // SSO endpoint info of the IdP. (Authentication Request protocol)
        'singleSignOnService' => array(
            // URL Target of the IdP where the SP will send the Authentication Request Message,
            // using HTTP-Redirect binding.
            'url' => $idp_host . '/login/saml',
        ),
        // SLO endpoint info of the IdP.
        'singleLogoutService' => array(
            // URL Location of the IdP where the SP will send the SLO Request,
            // using HTTP-Redirect binding.
            'url' => $idp_host . '/logoutsaml',
        ),
        'x509cert' => '',
        // Public x509 certificate of the IdP
         'certFingerprint' => 'C6:F1:3D:F4:98:4A:E0:84:75:66:94:B5:CF:7F:B5:3A:4F:44:13:61',
    ),
